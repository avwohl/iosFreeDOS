...
class HelpViewModel: ObservableObject {
    ...
    private static let indexURL = "https://github.com/avwohl/dosemu/releases/latest/download/help_index.json"
    private var baseURL: String = "https://github.com/avwohl/dosemu/releases/latest/download/"
